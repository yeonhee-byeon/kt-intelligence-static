...
function initSubBannerSectionAnimation() {
    ...
    if (!video || !subBannerList1 || !subBannerList2 || !subBannerList3 || !subBannerList4 || !subBannerList5 || !subBannerList6First || !subBannerList6Second) {
        return;
    }
...
function initParallaxDepthSectionAnimation() {
    ...
    const createDesktopTimeline = () => {
        ...
        cubeTl
            ...
            .to(cubeItems[2], { yPercent: 30, xPercent: 50, duration: 0.8, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }, "-=0.3")
            .to(cubeItems[3], { yPercent: 70, xPercent: 22, duration: 0.8, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }, "-=0.6")
            .to(cubeItems[4], { yPercent: 83, xPercent: 50, duration: 0.8, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }, "-=0.6")
            .to(cubeItems[5], { yPercent: 96, xPercent: 78, duration: 0.8, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }, "-=0.6")
            .to(
                cubeItems[0],
                {
                    yPercent: 75,
        ...
        cubeTl2.to(textGroup, { opacity: 0, zIndex: 3 }).to(cubeItems[6], { opacity: 1, duration: 0.5, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }).to(cubeTitle, { opacity: 1, duration: 0.5, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }).to(cubeDesc, { opacity: 1, duration: 0.5, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" });
    ...
    const createMobileTimeline = () => {
        ...
        cubeTl.to(cubeItems[1], { opacity: 1, duration: 0.3, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }).to(cubeItems[2], { yPercent: 10, xPercent: 50, duration: 0.8, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }, "-=0.3").to(cubeItems[3], { yPercent: 36, xPercent: 22, duration: 0.8, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }, "-=0.6").to(cubeItems[4], { yPercent: 49, xPercent: 50, duration: 0.8, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }, "-=0.6").to(cubeItems[5], { yPercent: 62, xPercent: 78, duration: 0.8, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }, "-=0.6").to(
            cubeItems[0],
            {
                yPercent: 50,
                xPercent: 50,
        ...
        cubeTl2.to(cubeList, { yPercent: 40, duration: 0.5, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }).to(cubeItems[6], { opacity: 1, duration: 0.5, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }).to(cubeTitle, { opacity: 1, duration: 0.5, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" }).to(cubeDesc, { opacity: 1, duration: 0.5, ease: "cubic-bezier(0.215, 0.61, 0.355, 1)" });
